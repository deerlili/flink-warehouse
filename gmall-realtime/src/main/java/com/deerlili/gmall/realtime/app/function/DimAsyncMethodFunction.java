 ...
 * @date 2022/8/1 14:49
 */
public abstract class DimAsyncMethodFunction<T> extends RichAsyncFunction<T, T> implements DimAsyncMethod<T> {

    private Connection connection;
    private ThreadPoolExecutor threadPoolExecutor;
    private String tableName;

    public DimAsyncMethodFunction(String tableName) {
